...
public class BaseClass {
	...
	// 51 select functionality Generic dropdown
	...
	// 18 -// now execute query which actually will scroll until that element is not
	// appeared on page.
	...
	public static void ScrolldownWebpageToEnd() {
		...
		// "document.body.scrollHeight" returns the complete height of the body i.e web
		// page.
	}
